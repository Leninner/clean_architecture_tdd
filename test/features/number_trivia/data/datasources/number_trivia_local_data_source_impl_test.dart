...
void main() {
  ...
  group('NumberTriviaLocalDataSourceImpl tests', () {
    group('When the getLastNumberTrivia method is called', () {
      ...
      test('should return a CachedException when there is not a cached value ',
          () async {
        // arrange
    ...
    group('When the cacheNumberTrivia method is called', () {
